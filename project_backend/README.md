...
1. Build the container image: `docker build . -t project_backend:2.4`

2. Import the image into k3d (or push to dockerhub): `k3d image import project_backend:2.4 -c <CLUSTER-NAME>`
